// ignore_for_file: unused_field, prefer_const_constructors, avoid_print, use_key_in_widget_constructors, must_be_immutable, unused_element, unused_local_variable, avoid_unnecessary_containers
    ...
    class _EditState extends State<Edit> {
      ...
      Future _getData() async {
        try {
          final response = await http.get(Uri.parse(
              ...
              "http://192.168.1.9/mynote/note/detail.php?id='${widget.id}'"));
      ...
      Future _onUpdate(context) async {
        try {
          return await http.post(
            Uri.parse("http://192.168.1.9/mynote/note/update.php"),
            body: {
              "id": widget.id,
              "title": title.text,
      ...
      Future _onDelete(context) async {
        try {
          return await http.post(
            Uri.parse("http://192.168.1.9/mynote/note/delete.php"),
            body: {
              "id": widget.id,
            },
          ).then((value) {
